...
function resetButton(opts,index){
	...
	$.each(buttons , function(key, val){					  
		if(($(val).attr('class').indexOf(buttonsSelectedTheme+opts.divId)>0))
		{  
            ...
            if(opts.theme=='theme3' || opts.theme=='theme4' || opts.theme=='theme5'){
                ...
                $("#caption_content_"+opts.divId+key).stop().animate({bottom:-(opts.arrHMC[index]+10)},{queue:false,duration:0});
            } 
		}
		if(index==key)

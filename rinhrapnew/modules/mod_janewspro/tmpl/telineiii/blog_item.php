...
<div class="ja-box column ja-zintheme<?php echo $cls_sufix;?><?php if (isset($y) && $y==0) echo ' ja-box-first' ?>">
	<div class="ja-box-inner inner clearfix">
    		...
    		foreach ($rows as $i=>$row){
    			...
    			<div class="ja-zincontent clearfix">
    				...
    				<h4 class="ja-zintitle">
    					<a href="<?php echo $row->link;?>" title="<?php echo strip_tags(($maxchars > strlen($row->introtext1)) ? $row->introtext : $row->introtext1);?>"><?php echo $row->title;?></a>
    				</h4>

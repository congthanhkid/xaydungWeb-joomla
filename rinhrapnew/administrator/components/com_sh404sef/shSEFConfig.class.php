 ...
 * @version     $Id: shSEFConfig.class.php 2207 2011-12-08 18:23:12Z silianacom-svn $
 */
...
class shSEFConfig {
  ...
  // 3.4
  var $enableMultiLingualSupport = false;
  var $enableOpenGraphData = false;
  var $ogEnableDescription = true;
  var $ogType = 'article';
  var $ogImage = '';
  var $ogEnableSiteName = true;
  var $ogSiteName = '';
  var $ogEnableLocation = false;
  var $ogLatitude = '';
  var $ogLongitude = '';
  var $ogStreetAddress = '';
  var $ogLocality = '';
  ...
  var $ogRegion = '';
  var $ogCountryName = '';
  var $ogEnableContact = false;
  var $ogEmail = '';
  var $ogPhoneNumber = '';
  var $ogFaxNumber = '';
  var $fbAdminIds = '';

  var $socialButtonType = 'facebook';

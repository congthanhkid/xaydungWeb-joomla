 ...
 * @version     $Id: html.php 2128 2011-11-08 19:12:36Z silianacom-svn $
 */
...
class Sh404sefHelperHtml {
   ...
   * @return  string HTML output
   */
  public static function buildDashboardDataTypeList( $current, $name, $autoSubmit = false, $addSelectAll = false, $selectAllTitle = '', $customSubmit = '') {
  ...
  public static function buildOpenGraphTypesList( $current, $name, $autoSubmit = false, $addSelectDefault = false, $selectDefaultTitle = '', $customSubmit = '') {
    ...
    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_ACTIVITIES'),
    'items' => array(
    array( 'id' => 'activity', 'title' => JText::_('COM_SH404SEF_OG_TYPES_ACTIVITY'))
    , array( 'id' => 'sport', 'title' => JText::_('COM_SH404SEF_OG_TYPES_SPORT'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_BUSINESSES'),
    'items' => array(
    array( 'id' => 'bar', 'title' => JText::_('COM_SH404SEF_OG_TYPES_BAR'))
    , array( 'id' => 'company', 'title' => JText::_('COM_SH404SEF_OG_TYPES_COMPANY'))
    , array( 'id' => 'cafe', 'title' => JText::_('COM_SH404SEF_OG_TYPES_CAFE'))
    , array( 'id' => 'hotel', 'title' => JText::_('COM_SH404SEF_OG_TYPES_HOTEL'))
    , array( 'id' => 'restaurant', 'title' => JText::_('COM_SH404SEF_OG_TYPES_RESTAURANT'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_GROUPS'),
    'items' => array(
    array( 'id' => 'cause', 'title' => JText::_('COM_SH404SEF_OG_TYPES_CAUSE'))
    , array( 'id' => 'sports_league', 'title' => JText::_('COM_SH404SEF_OG_TYPES_SPORTS_LEAGUE'))
    , array( 'id' => 'sports_team', 'title' => JText::_('COM_SH404SEF_OG_TYPES_SPORTS_TEAM'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_ORGANIZATIONS'),
    'items' => array(
    array( 'id' => 'band', 'title' => JText::_('COM_SH404SEF_OG_TYPES_BAND'))
    , array( 'id' => 'government', 'title' => JText::_('COM_SH404SEF_OG_TYPES_GOVERNMENT'))
    , array( 'id' => 'non_profit', 'title' => JText::_('COM_SH404SEF_OG_TYPES_NON_PROFIT'))
    , array( 'id' => 'school', 'title' => JText::_('COM_SH404SEF_OG_TYPES_SCHOOL'))
    , array( 'id' => 'university', 'title' => JText::_('COM_SH404SEF_OG_TYPES_UNIVERSITY'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_PEOPLE'),
    'items' => array(
    array( 'id' => 'actor', 'title' => JText::_('COM_SH404SEF_OG_TYPES_ACTOR'))
    , array( 'id' => 'athlete', 'title' => JText::_('COM_SH404SEF_OG_TYPES_ATHLETE'))
    , array( 'id' => 'author', 'title' => JText::_('COM_SH404SEF_OG_TYPES_AUTHOR'))
    , array( 'id' => 'director', 'title' => JText::_('COM_SH404SEF_OG_TYPES_DIRECTOR'))
    , array( 'id' => 'musician', 'title' => JText::_('COM_SH404SEF_OG_TYPES_MUSICIAN'))
    , array( 'id' => 'politician', 'title' => JText::_('COM_SH404SEF_OG_TYPES_POLITICIAN'))
    , array( 'id' => 'public_figure', 'title' => JText::_('COM_SH404SEF_OG_TYPES_PUBLIC_FIGURE'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_PLACES'),
    'items' => array(
    array( 'id' => 'city', 'title' => JText::_('COM_SH404SEF_OG_TYPES_CITY'))
    , array( 'id' => 'country', 'title' => JText::_('COM_SH404SEF_OG_TYPES_COUNTRY'))
    , array( 'id' => 'landmark', 'title' => JText::_('COM_SH404SEF_OG_TYPES_LANDMARK'))
    , array( 'id' => 'state_province', 'title' => JText::_('COM_SH404SEF_OG_TYPES_STATE_PROVINCE'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_PROD_AND_ENTERTAINMENT'),
    'items' => array(
    array( 'id' => 'album', 'title' => JText::_('COM_SH404SEF_OG_TYPES_ALBUM'))
    , array( 'id' => 'book', 'title' => JText::_('COM_SH404SEF_OG_TYPES_BOOK'))
    , array( 'id' => 'drink', 'title' => JText::_('COM_SH404SEF_OG_TYPES_DRINK'))
    , array( 'id' => 'food', 'title' => JText::_('COM_SH404SEF_OG_TYPES_FOOD'))
    , array( 'id' => 'game', 'title' => JText::_('COM_SH404SEF_OG_TYPES_GAME'))
    , array( 'id' => 'product', 'title' => JText::_('COM_SH404SEF_OG_TYPES_PRODUCT'))
    , array( 'id' => 'song', 'title' => JText::_('COM_SH404SEF_OG_TYPES_SONG'))
    , array( 'id' => 'movie', 'title' => JText::_('COM_SH404SEF_OG_TYPES_MOVIE'))
    , array( 'id' => 'tv_show', 'title' => JText::_('COM_SH404SEF_OG_TYPES_TV_SHOW'))
    )),

    array(
    'text' => JText::_('COM_SH404SEF_OG_TYPES_GROUP_WEBSITES'),
    'items' => array(
    array( 'id' => 'blog', 'title' => JText::_('COM_SH404SEF_OG_TYPES_BLOG'))
    , array( 'id' => 'website', 'title' => JText::_('COM_SH404SEF_OG_TYPES_WEBSITE'))
    , array( 'id' => 'article', 'title' => JText::_('COM_SH404SEF_OG_TYPES_ARTICLE'))

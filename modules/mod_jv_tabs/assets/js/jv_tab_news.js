var JVTabNews = new Class({
	...
	initialize:function(options){
		...
		this.tabPanels = $ES('div.jv_tabs_panel .jv_news_content',this.options.container);		
		this.currentTab = 0;
...
JVTabNews.implement(new Events);
JVTabNews.implement(new Options);
...
JHTML::_('stylesheet','style.css','modules/mod_jv_tabs/assets/stylies/jv_lago/');
...
<div class="jv_tab_lago_wrap" style="<?php echo $lago2ModWidth.";".$modHeight; ?>">
<div class="jv_tab_lago_container">
	<div class="jv_tablago2" id="jv_tablago2<?php echo $moduleId; ?>">
		<div class="lago_title" style="<?php echo $titleHeight; ?>">
			<ul class="tabs_title">

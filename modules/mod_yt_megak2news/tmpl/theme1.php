...
<?php defined( '_JEXEC' ) or die( 'Restricted access' ); ?>
   ...
   <div id="yt-megak2-news" class="yt_mega_k2_news">
     <div style="text-align: left; float: left; width: 100%"><?php echo $intro_text; ?></div>
        <div id="ytc_tabs<?php echo $module->id;?>" class="theme1">
	   ...
	   foreach ($items as $key=>$value) {                       
		 ...
		 ?>
		  <div style="width:<?php echo $width_module;?>%; float: left;"> <?php }?>
		   <div class="box" style="width:<?php echo ($width_category);?>%"> 			
                ...
                ?>
					...
					<div class="normal-content">	
					  <div class="col-one col">
					   ...
					   <div class="more">
					    <div style=" color:#7a7a7b; font-weight: bold"> MORE: </div>
					      <div class="link">
						  <ul> <?php $i=1; foreach($value as $key1=>$value1){if($i!=1){?>
                                <li>
								<div class="arrow">&nbsp;&nbsp;</div>
								<a href="<?php echo $value1['link']?>" target="<?php echo $target; ?>"><?php echo $value1['title']?>
								</a></li>
                                 <?php };$i++;}?>                            
                            </ul>
					      </div>		

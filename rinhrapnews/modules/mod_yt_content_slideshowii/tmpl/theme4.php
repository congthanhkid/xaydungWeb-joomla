...
$jYtc(document).ready(function($) {
        ...
        function(){$('.buttons-theme-hover_<?php echo $module->id;?>').addClass("buttons-theme4")},
        function(){$('.buttons-theme-hover_<?php echo $module->id;?>').removeClass("buttons-theme4")}
        );
       <?php endif;?> 
...
<div class="yt_slideshowii_module" id="yt_slideshowii_module_<?php echo $module->id;?>" style="width: <?php echo $width_module_slide_ii;?>px; height: <?php echo $thumb_height?>">
    <?php ob_start();?>
    	<div class="ytc-content-slideshow-theme1" style="width: <?php echo $thumb_width?>px; height:<?php echo $thumb_height?>px; z-index:4; float: left !important; position:relative;overflow:hidden;<?php if(!$show_img_on_right){?>float:left;<?php }?>">
            <div class="buttons-theme-hover_<?php echo $module->id;?> <?php if($show_buttons_slideii == 1|| $show_buttons_slideii == 0){echo "buttons-theme4";}?>" style="top:<?php echo ($thumb_height - 50);?>px !important; <?php if($show_buttons_slideii==0){echo "display:none";}?>">
            ...
            <div id="featured<?php echo $module->id;?>" style="width:<?php echo $thumb_width;?>px !important;height:<?php echo $thumb_height?>px !important;">
                <?php foreach($items as $key=>$item) {?>
    				<div style="text-decoration: none;height:<?php echo $thumb_height?>px !important;position:absolute;overflow:hidden;">
                        ...
                        <div class="caption_opacity_theme4 caption_opacity_theme3_<?php echo $module->id?>" id="caption_<?php echo $module->id.$key?>" style="<?php if(!$key){echo "bottom:{$thumb_height}px; display: block;";}?> float: left;">
    ...
    <?php ob_start();?>
    	<div id="content_box_<?php echo $module->id;?>" class="content_box_<?php echo $module->id;?>" style="overflow:hidden; float: left; width:<?php echo ($width_module_slide_ii - $thumb_width);?>px; height:<?php echo $heightItem * $num_item_per_page?>px;  position:relative" >	
    								...
    								<?php foreach($items as $key=>$item) {?>
    									<li class="li_height_item_<?php echo $module->id;?> <?php echo ($key==$start)?"button_img_selected_{$module->id}":"button_img_{$module->id}";?>" value="<?php echo $key;?>" style="overflow: hidden;">
                                            <div class="yt_post_item yt_post_item_multi_<?php echo $module->id;?>" style="border-bottom: 1px #c0c0c0 solid; height: <?php echo $normalHeight;?>px;overflow:hidden;">
                                    			<div class="yt_meta_img_theme4 yt_meta_img_theme" style="display:<?php echo $show_normal_image?"block":"none";?>;">

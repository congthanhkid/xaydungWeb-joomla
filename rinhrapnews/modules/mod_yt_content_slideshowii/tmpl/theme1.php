...
$jYtc(document).ready(function($) {
        ...
        function(){$('.buttons-theme-hover_<?php echo $module->id;?>').addClass("buttons-theme1")},
        function(){$('.buttons-theme-hover_<?php echo $module->id;?>').removeClass("buttons-theme1")}
        );
        <?php endif;?> 
...
<div class="yt_slideshowii_module" id="yt_slideshowii_module_<?php echo $module->id;?>" style="background:white; width: <?php echo $width_module_slide_ii;?>px; height: <?php echo $thumb_height?>">
    <?php ob_start();?>
    	<div class="ytc-content-slideshow-theme1" style="width: <?php echo $thumb_width?>px; height:<?php echo $thumb_height?>px; z-index:4; float: left !important; position:relative;overflow:hidden;<?php if(!$show_img_on_right){?>float:left;<?php }?>">
            <div class="buttons-theme-hover_<?php echo $module->id;?> <?php if($show_buttons_slideii == 1|| $show_buttons_slideii == 0){echo "buttons-theme1";}?>" style="<?php if($show_buttons_slideii==0){echo "display:none";}?>">
                ...
                <?php foreach($items as $key=>$item) {?>
    				<div style="text-decoration: none;height:<?php echo $thumb_height?>px!important;position:absolute;overflow:hidden;">
                        <div style="z-index:1; width:<?php echo $thumb_width?>px; height:<?php echo $thumb_height;?>px; ">
                            ...
                            <div id="caption_content_<?php echo $module->id.$key?>" class="caption_content_<?php echo $module->id?> caption_content" style="width:<?php echo $thumb_width?>px;<?php if(!$key){echo "bottom: 0px";}?>;">
                                    <?php if($show_caption_slide == 1):?>
                                    <div style="width:<?php echo $thumb_width - 18?>px; color:<?php echo $main_color;?> !important; text-align: left; margin-top:6px;"><?php echo $item['sub_main_content']?></div>
                                    <?php endif;?> 
    				...
    				<div class="right">
    					<div class="center">	
    						<div style="position:relative; z-index:1;" class="buttons_<?php echo $theme;?>">					
    							<ul id="image_button_<?php echo $module->id;?>" style="padding: 0px !important;position: relative !important;list-style: none; cursor: pointer;margin-top: 0px; margin-left: 0px;">
    								<?php foreach($items as $key=>$item) {?>
    									<li class="li_height_item_<?php echo $module->id;?> <?php echo ($key==$start)?"button_img_selected_{$module->id}":"button_img_{$module->id}";?>" value="<?php echo $key;?>" style="overflow: hidden;">
                                            <div class="yt_post_item yt_post_item_multi_<?php echo $module->id;?>" style="border-bottom: 1px #c0c0c0 solid; height: <?php echo $normalHeight;?>px;overflow:hidden;">
                                    			<div class="yt_meta_img_theme1 yt_meta_img_theme" style="display:<?php echo $show_normal_image?"block":"none";?>;">
                                    				<?php if($item['small_thumb'] !=''):?><a href="<?php echo ($link_image)?$item['link']:"#";?>" target = "<?php echo $target;?>" style="padding: 0px;background: none !important;" ><img src="<?php echo $item['small_thumb']?>" title="<?php echo $item['title'];?>" alt="" border="none" /></a><?php endif;?>
                                                    <?php if($item['small_thumb'] ==''):?>&nbsp;<?php endif;?>
                                    			</div>
                                    			<div class="yt_item_title" style="display:<?php echo ($show_title_slideshowii)?"block":"none"?>"><a href="<?php echo $item['link']?>" title="<?php echo $item['title'];?>" style="padding:0px !important;"><?php echo $item['sub_title']?></a></div>

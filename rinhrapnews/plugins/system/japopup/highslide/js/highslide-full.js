...
writeExtendedContent : function () {
	...
	if (this.objectType == 'iframe') {
		...
		if(this.src.indexOf("http://www.youtube.com/v/") == 0){
			this.body.innerHTML += '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="100%" height="100%">'
	  					+ '<param name="movie" value="'+this.src+'" /><param name="quality" value="high" /><param name="allowFullScreen" value="true"/>'
	  					+ '<embed src="'+this.src+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" allowFullScreen="true" type="application/x-shockwave-flash" width="100%" height="100%"></embed></object>'
						+ '<iframe name="hs'+ (new Date()).getTime() +'" frameborder="0" key="'+ this.key +'" '
...
showHideElements : function (tagName, visibility) {
	...
	for (var i = 0; i < els.length; i++) {
		if (prop == 'visibility' || (document.defaultView.getComputedStyle(
				...
				|| els[i].get('hidden-by') != null)) {
			var hiddenBy = els[i].get('hidden-by');

                ...
                case "image":
                    {
                        ...
                        $str .= '<a class="highslide" href="' . $arrData['href'] . '" onclick="return hs.expand(this, {dimmingOpacity:'.$arrData['overlayOpacity'].', outlineType:' . $arrData['outlineType'] . ' ' . $arrData['captionId'] . '});" >' . $content . "</a>";
                        break;
                    }
                ...
                case "slideshow":
                    {
                        ...
                        foreach ($modalContent as $k => $v) {
                            ...
                            $str .= '<a class="highslide" href="' . $image_url . '" onclick="return hs.expand(this, {dimmingOpacity:'.$arrData['overlayOpacity'].', outlineType:' . $arrData['outlineType'] . ', captionId: \'ja-highslide' . $ranID . '\'});" >' . $arrData['content'] . '</a>';
                        }
                        // Caption Area

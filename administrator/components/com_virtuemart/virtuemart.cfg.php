...
define( 'URL', 'http://localhost/Demo/2012/Dienthoai52/' );
define( 'SECUREURL', 'http://localhost/Demo/2012/Dienthoai52/' );
...
define('VM_ONCHECKOUT_LEGALINFO_SHORTTEXT', 'Chính sách hoàn lại
...
Để biết thêm thông tin về việc huỷ bỏ đơn đặt hàng và trả lại hàng, xem thông  Chính sách trả lại của chúng tôi tại trang .');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', 'e5befcbc6cacf4e33420d68bb5a3a4ec');
...
$VM_BROWSE_ORDERBY_FIELDS = array( 'product_cdate' );

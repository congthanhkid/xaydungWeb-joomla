...
$langvars = array (
	...
	'PHPSHOP_DOWNLOADS_CLICK' => 'Nhấn vào tên sản phẩm để tải tập tin xuống.',
	'PHPSHOP_DOWNLOADS_EXPIRED' => 'Bạn đã tải về các file (s) tối đa số lần, hoặc tải về khoảng thời gian đã hết hạn.'

...
function sefUpdate()
{
    ...
    try {
    	...
    	sefAjaxUpdate.send('option=com_sef&controller=sefurls&task=updateMetaNext&tmpl=component');
    }
    catch (e) {
    }
}
...
{
	document.getElementById('urls_message').innerHTML = '<?php echo JText::_('METATAGS_UPDATE_COMPLETED'); ?>';
...
<legend><?php echo JText::_('METATAGS_UPDATE_TITLE'); ?></legend>
<div id="urls_table">
<table class="adminform">
<tr>
    <th colspan="2" id="urls_message">
        <?php echo JText::_('METATAGS_UPDATE_PROGRESS'); ?>
    </th>
</tr>
<tr>
    <td width="100"><?php echo JText::_('METATAGS_UPDATE_UPDATED'); ?>:</td>
    <td id="urls_updated">0</td>
</tr>
<tr>
    <td width="100"><?php echo JText::_('METATAGS_UPDATE_LEFT'); ?>:</td>
    <td id="urls_left"><?php echo $this->totalUrls; ?></td>
</tr>
<tr>
    <td width="100"><?php echo JText::_('METATAGS_UPDATE_TOTAL'); ?>:</td>
...
<table class="adminform">
<tr>
    <th><?php echo JText::_('METATAGS_UPDATE_ERROR'); ?></th>
</tr>
<tr>

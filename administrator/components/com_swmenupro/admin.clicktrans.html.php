...
function clickTransMenuConfig( $rows,$row2, $menutype,$pageNav, $mainpadding, $subpadding, $mainborder, $subborder, $mainborderover, $subborderover, $modulename, $ordered, $parent_id,$orders2, $lists,$orders3,$moduleclass_sfx)
{
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="bottom"><span class="swmenu_sectionname"><?php echo _SW_CLICK_TRANS_MENU." "._SW_MODULE_EDITOR; ?></span> </td>
     <td valign="top" >
      <ul>
...
<table width="750">
            <tr> 
              <td valign="top" > 
                <table width="360" height="180" style="border:0px solid #cccccc;">
          ...
          <td align="right" ><?php echo $lists['selectbox_hack']; ?> </td>
        </tr><tr>
          ...
          <input type="text" size="8" id="level2_sub_left" name="level2_sub_left" value="<?php echo $rows->level2_sub_left;?>"/>px</div></td>
              ...
              <td valign="top" align="center"> 
                <table width="360"  style="border:0px solid #cccccc;" >
                  <tr>
                    <td class="swmenu_tabheading"><div align="center"><?php echo _SW_CLICK_DIMENSIONS_LABEL; ?></div></td>
                  </tr><tr> 
                    <td align="center"> <img src="components/com_swmenupro/images/click_dimensions.png" width="342" height="320" border="0" hspace="0" vspace="0" align="center"/> </td>
                  </tr> 				 
                </table></td> 
            </tr> 
       </table> 
...
<table width="100%" valign="top" cellspacing="0" cellpadding="0" border="0">
  <tr><td align="center">
     ...
     <table>
        <tr>
          <td align="center" valign="top"> <img src="components/com_swmenupro/images/mygosu_border.png" width="342" height="320" border="0" hspace="0" vspace="0"/> </td>
        </tr>
     </table>
    </td>
  </tr>
            ...
            <tr>
             ...
             <tr>
                  ...
                  <tr > 
                    ...
                    <td width="120" class="adminlist"> <div align="right"> 
                    <input id="specialA" name="specialA" type="text" value="<?php echo $rows->specialA;?>" size="8"/>%&nbsp;</div></td>
                  </tr> 
                  <tr class="swmenu_menubackgr">
...
<input type="hidden" name="menustyle" value="clicktransmenu" />

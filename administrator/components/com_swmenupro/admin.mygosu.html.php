...
function gosuMenuConfig( $rows,$row2, $menutype,$pageNav, $mainpadding, $subpadding, $mainborder, $subborder, $mainborderover, $subborderover, $modulename, $ordered, $parent_id,$orders2, $lists,$orders3,$moduleclass_sfx)
{
	global $mainframe;
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="bottom"><span class="swmenu_sectionname"><?php echo _SW_MYGOSU_MENU." "._SW_MODULE_EDITOR; ?></span> </td>
     <td valign="top" >
      <ul>
       <?php if (file_exists($mosConfig_absolute_path."/modules/mod_swmenupro/styles/menu".$row2->id.".css")&&$row2->id){ ?>
      <li><a href="index.php?option=com_swmenupro&task=editCSS&id=<?php echo $row2->id; ?>" ><?php echo _SW_CSS_LINK; ?></a></li>
       <?php } else{ ?>
...
<table width="100%">
  <tr>
    <td align="center"> <img src="components/com_swmenupro/images/mygosu_offsets.png" width="750" height="480" border="0" hspace="0" vspace="0"/> </td>
  </tr>
</table>
      ...
      <table width="360" style="border:0px solid #cccccc;" >
       <tr>
         <td colspan="2" class="swmenu_tabheading"> <div align="center"><?php echo _SW_GENERAL_LABEL; ?></div></td>
          ...
          <td valign="top"><?php echo _SW_AUTO_SUB; ?>:</td>
          <td><a href="javascript:void(0);" onmouseover="return escape('<?php echo _SW_AUTO_SUB_TIP; ?>')" >
	      <img src="components/com_swmenupro/images/info.png" alt="info" align="middle" name="info" border="0" /></a>

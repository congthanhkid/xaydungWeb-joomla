...
function popoutMenuConfig( $rows,$row2, $menutype,$pageNav, $mainpadding, $subpadding, $mainborder, $subborder, $mainborderover, $subborderover, $modulename, $ordered, $parent_id,$orders2, $lists,$orders3,$moduleclass_sfx)
{
	global $mainframe;
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="bottom"><span class="swmenu_sectionname"><?php echo _SW_TIGRA_MENU." "._SW_MODULE_EDITOR; ?></span> </td>
     <td valign="top" >
      <ul>
    ...
    <td valign="top" > 
      <table width="360" style="border:0px solid #cccccc;height:200px" >
        <tr>
          ...
          <td><?php echo _SW_TOP_MENU." - "._SW_POSITION; ?>:</td>
...
<table width="100%">
  <tr>
    <td align="center"> <img src="components/com_swmenupro/images/tigra_offsets.png" width="750" height="480" border="0" hspace="0" vspace="0"/> </td>
  </tr>
</table>
...
<table width="750">
  ...
  <td valign="top"> 
    <table width="360" style="border:0px solid #cccccc;height:260px;" >
       <tr>
         ...
         <td> 
          ...
          <td width="120"> <div align="right">
           ...
           <td><?php echo _SW_TOP_MENU." "._SW_NORMAL_BORDER_COLOR; ?>:</td>
           <td> 
          ...
          <td><?php echo _SW_TOP_MENU." "._SW_OVER_BORDER_COLOR; ?>:</td>
          <td>
         ...
         <td><?php echo _SW_SUB_MENU." "._SW_NORMAL_BORDER_COLOR; ?>:</td>
         <td>
      ...
      <td><?php echo _SW_SUB_MENU." "._SW_OVER_BORDER_COLOR; ?>:</td>
      <td> 
...
<table width="100%" valign="top" cellspacing="0" cellpadding="0" border="0">
  <tr><td align="center">
     ...
     <table>
        <tr>
          <td align="center" valign="top"> <img src="components/com_swmenupro/images/tigra_border.png" width="342" height="320" border="0" hspace="0" vspace="0"/> </td>
        </tr>
     </table>
    </td>
  </tr>
      ...
      <tr>
        <td valign="top" >
          <table width="360" height="130" style="border:0px solid #cccccc;">
            <tr>
              ...
              <td><?php echo _SW_TOP_MENU." "._SW_NORMAL_BORDER." "._SW_STYLE; ?>:</td>
              <td width="120"><div align="right"><?php echo $lists['main_border_style']; ?></div></td>
            </tr><tr>
              <td><?php echo _SW_TOP_MENU." "._SW_OVER_BORDER." "._SW_STYLE; ?>:</td>
              <td width="120"><div align="right"><?php echo $lists['main_border_over_style']; ?></div></td>
            </tr><tr class="swmenu_menubackgr">
              <td><?php echo _SW_SUB_MENU." "._SW_NORMAL_BORDER." "._SW_STYLE; ?>:</td>
              <td width="120"><div align="right"><?php echo $lists['sub_border_style']; ?></div></td>
            </tr><tr>
              <td><?php echo _SW_SUB_MENU." "._SW_OVER_BORDER." "._SW_STYLE; ?>:</td>
        ...
        <td>
          ...
          <table width="100%" cellspacing="5" cellpadding="5">
            <tr>
              <td align="center" style="height:20px;border:1px dashed #000000; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 1px Wide and Dashed</td>
            </tr><tr>
              <td align="center" style="height:20px;border:2px dashed #000000; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 2px Wide and Dashed</td>
            </tr><tr>
              <td align="center" style="height:20px;border:1px solid #000000; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 1px Wide and Solid</td>
            </tr><tr>
              <td align="center" style="height:20px;border:2px solid #000000; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 2px Wide and Solid</td>
            </tr><tr>
              <td align="center" style="height:20px;border:2px dotted #669900; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 2px Wide and Dotted</td>
            </tr><tr>
              <td align="center" style="height:20px;border:4px inset #6633FF; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 4px Wide and Inset</td>
            </tr><tr>
              <td align="center" style="height:20px;border:4px double #339900; background-color:#68acdc; color:#FFFFFF; font-weight:bold">
              This Border is 4px Wide and Double</td>
            </tr><tr>
              <td align="center" style="height:30px;border:4px ridge #FF0000; background-color:#68acdc; color:#FFFFFF; font-weight:bold;">
              This Border is 4px Wide and Ridged</td>
            </tr>
          </table>
        </td>       
      </tr>

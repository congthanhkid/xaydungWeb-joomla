...
require_once($absolute_path."/administrator/components/com_swmenupro/ImageManager/config.inc.php");

require_once($absolute_path."/administrator/components/com_swmenupro/ImageManager/Classes/ImageManager.php");
...
<head>
 ...
 <link href="components/com_swmenupro/ImageManager/assets/manager.css" rel="stylesheet" type="text/css" />	
<script type="text/javascript" src="components/com_swmenupro/ImageManager/assets/popup.js"></script>
...
<script type="text/javascript" src="components/com_swmenupro/ImageManager/assets/manager.js"></script>
</head>
<body>
<div class="title">Insert Image</div>
<form action="index3.php?option=com_swmenupro&task=imageFiles" id="uploadForm" method="post" enctype="multipart/form-data">
...
<?php } ?>
	...
	<a href="#" onclick="javascript: goUpDir();" title="Directory Up"><img src="components/com_swmenupro/ImageManager/img/btnFolderUp.gif" height="15" width="15" alt="Directory Up" /></a>
<?php if($IMConfig['safe_mode'] == false && $IMConfig['allow_new_dir']) { ?>
	<a href="#" onclick="newFolder();" title="New Folder"><img src="components/com_swmenupro/ImageManager/img/btnFolderNew.gif" height="15" width="15" alt="New Folder" /></a>
<?php } ?>
	<div id="messages" style="display: none;"><span id="message"></span><img SRC="components/com_swmenupro/ImageManager/img/dots.gif" width="22" height="12" alt="..." /></div>
	<iframe src="index3.php?option=com_swmenupro&task=imageFiles" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
</div>
</fieldset>
<!-- image properties -->
	<table class="inputTable">
		<tr>
			...
			<td rowspan="2" align="right"><img src="components/com_swmenupro/ImageManager/img/locked.gif" id="imgLock" width="25" height="32" alt="Constrained Proportions" /></td>
			<td rowspan="3" align="right">&nbsp;</td>

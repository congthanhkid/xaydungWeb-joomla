 ...
 */
	...
	if(JFolder::exists(JPATH_SITE.DS.'plugins/system/jsecure') ){
		JFile::delete( JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure' );
	}
	JFolder::create(JPATH_SITE.DS.'plugins/system/jsecure');
	JFile::move( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'jsecure'.DS.'jsecure.class.php', JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure.class.php');

	JFolder::create(JPATH_SITE.DS.'plugins/system/jsecure/css');
	JFile::move( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'jsecure'.DS.'css'.DS.'jsecure.css', JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'css'.DS.'jsecure.css');

	if ($r1 && $r2 && $r3) {
		  $sql="INSERT INTO `#__plugins` ( `name`, `element`, `folder`, `access`, `ordering`, `published`, `iscore`, `client_id`, `checked_out`, `checked_out_time`, `params`) VALUES ('System - jsecure', 'jsecure', 'system', 0, 7, 1, 0, 0, 0, '0000-00-00 00:00:00', '');";
	...
	if (file_exists(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure.php') && file_exists(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'jsecure'.DS.'jsecure.class.php')) {
